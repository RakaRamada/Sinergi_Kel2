...
$queries = [
    ...
    "CREATE TABLE groups (
        ...
        CONSTRAINT fk_groups_creator FOREIGN KEY (created_by_user_id) REFERENCES users(user_id)
    )",
    ...
    "CREATE TABLE likes (
        likes_id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
        user_id NUMBER NOT NULL,
    ...
    "CREATE TABLE messages (
        ...
        created_at TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
        CONSTRAINT fk_messages_group FOREIGN KEY (group_id) REFERENCES groups(group_id),
    ...
    "CREATE TABLE notifications (
        ...
        CONSTRAINT fk_notif_related_group FOREIGN KEY (related_group_id) REFERENCES groups(group_id)
    )",
    ...
    "INSERT INTO groups (nama_group, deskripsi, created_by_user_id) 
     VALUES ('PHP Native Dasar', 'Diskusi dasar-dasar PHP tanpa framework', 2)",
    "COMMIT",

    "INSERT INTO postingan (user_id, group_id, konten, post_image) 
    ...
    "INSERT INTO messages (group_id, sender_id, isi_pesan) VALUES (1, 1, 'Halo, ada yang bisa bantu koneksi OCI8?')",
    "INSERT INTO messages (group_id, sender_id, isi_pesan) VALUES (1, 2, 'Coba cek dokumentasi PHP, Achonk.')",
    "COMMIT"
];
