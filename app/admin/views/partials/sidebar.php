...
<aside class="fixed top-0 left-0 h-full w-20 bg-white border-r border-gray-200 flex flex-col items-center py-6 space-y-6 z-40">
  ...
  <!-- Logo -->
  <a href="/Sinergi/index.php?page=admin-dashboard" class="block p-1 hover:opacity-90 transition-opacity" title="Dashboard">
  ...
  <a href="/Sinergi/index.php?page=admin-dashboard" 
     ...
     title="Laporan">
     <!-- Icon Report -->
    <img src="/Sinergi/public/assets/icons/report.svg" alt="Laporan" class="w-6 h-6 <?php echo ($currentPage == 'admin-dashboard') ? 'opacity-100' : 'opacity-70'; ?>">
  </a>
  ...
  <a href="/Sinergi/index.php?page=admin-analytics" 
    ...
    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 <?php echo ($currentPage == 'admin-analytics') ? 'text-indigo-600' : 'text-gray-500'; ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
