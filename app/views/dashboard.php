            ...
            <div class="bg-white border-x border-t border-b border-gray-200">
                ...
                <form id="create-post-form" method="POST" enctype="multipart/form-data">
                    <div class="flex items-start space-x-3 p-4">                   
                        ...
                        class="w-full border-0 focus:ring-0 resize-none p-2 text-lg"
                    ...
                    <div id="image-preview-container" class="hidden p-4 pt-0 relative">
                        ...
                        <button type="button" id="remove-image-btn" class="absolute top-2 left-6 bg-black bg-opacity-50 text-white rounded-full p-1 hover:bg-opacity-70">
                    ...
                    <div class="flex justify-between items-center mt-2 p-4 border-t border-gray-200">
                        <div class="flex items-center space-x-2 text-gray-500">
                            <label for="post-image-input" title="Gambar" class="p-2 rounded-full cursor-pointer hover:bg-gray-100 text-blue-500 transition-colors">
