                ...
                <form method="post" action="index.php?page=register-process" class="space-y-4" id="registerForm">
                    ...
                    <div>
                        ...
                        <select id="role" name="role" required onchange="updateFormRules()"
                            ...
                            <option value="1" <?php echo (isset($old_data['role']) && $old_data['role'] == '1') ? 'selected' : ''; ?>>Mahasiswa</option>
                            <option value="2" <?php echo (isset($old_data['role']) && $old_data['role'] == '2') ? 'selected' : ''; ?>>Dosen</option>
                            <option value="4" <?php echo (isset($old_data['role']) && $old_data['role'] == '4') ? 'selected' : ''; ?>>Mitra Industri</option>
                            <option value="3" <?php echo (isset($old_data['role']) && $old_data['role'] == '3') ? 'selected' : ''; ?>>Alumni</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" placeholder="Email Kampus (@stu.pnj.ac.id)" 
                            ...
                            required
                            class="w-full border border-gray-300 rounded-lg py-3 px-4 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <p id="email_helper" class="text-xs text-gray-500 mt-1 ml-1">Wajib menggunakan email @stu.pnj.ac.id</p>
                    </div>
