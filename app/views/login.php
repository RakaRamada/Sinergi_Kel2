...
<body>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <span class="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer"
                                ...
                                <img id="togglePasswordIcon" src="public/assets/icons/eyeClosed.svg" alt="Toggle password visibility" class="w-5 h-5 text-gray-400">
                            </span>
                        </div>
                    </div>
    ...
    function refreshCaptcha() {
        ...
        // PERBAIKAN 2: Perbaiki path (ke router) dan typo (? bukan t)
