            ...
            <div class="<?= $card_style ?> w-full max-w-[85%] md:max-w-[70%]">
                ...
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <button onclick="deleteForumPost(<?= $post['post_id'] ?>)"
                        class="absolute top-3 right-3 text-gray-300 hover:text-red-500 transition p-1 rounded-full hover:bg-gray-50 opacity-0 group-hover:opacity-100 cursor-pointer"
                        title="Hapus Diskusi">
        ...
        <form action="index.php?page=store-forum-post" method="POST" enctype="multipart/form-data"
            ...
            <div class="relative">
                ...
                <button type="button" onclick="document.getElementById('hiddenFileInput').click()"
                    class="p-2.5 text-gray-500 hover:bg-gray-100 rounded-full transition shrink-0 cursor-pointer">
            ...
            <button type="submit"
                class="p-2.5 bg-black text-white rounded-full hover:bg-gray-800 transition shrink-0 shadow-sm flex items-center justify-center cursor-pointer">
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm transform scale-95 transition-transform duration-200"
            ...
            <div class="mt-6 flex gap-3">
                ...
                <button type="button" id="confirmDeleteForumBtn"
                    class="w-full inline-flex justify-center rounded-xl border border-transparent shadow-sm px-4 py-2.5 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none transition cursor-pointer shadow-red-200 cursor-pointer">
                    Hapus
                </button>
            </div>
        </div>
