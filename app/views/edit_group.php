<?php
// File: app/views/edit_group.php
// Konten ini dipanggil oleh index.php (Rombakan Besar)
// Variabel $group_info dikirim oleh GroupController.php
?>
...
<main class="col-span-6 border-r border-gray-200">
    ...
    <div
        ...
        <h2 class="text-xl font-bold">Edit Group: <?= htmlspecialchars($group_info['nama_group']) ?></h2>
    </div>

    <div class="p-6">
        <form action="index.php?page=update-group" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" id="nama_group" name="nama_group"
                    value="<?= htmlspecialchars($group_info['nama_group']) ?>"
