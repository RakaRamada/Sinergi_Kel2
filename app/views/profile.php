<main class="col-span-6 border-r border-gray-200 min-h-screen bg-white">
    ...
    <div class="border-b border-gray-200 mt-2 sticky top-[73px] bg-white z-10">
        <div class="flex px-4">
            <div
                class="border-b-4 border-black py-3 px-4 font-bold text-black text-sm cursor-pointer hover:bg-gray-50 transition">
                Postingan
            </div>
        </div>
    </div>
            ...
            <div class="p-4">
                <div class="flex items-start space-x-3">
                    <div class="flex-shrink-0 cursor-pointer"
                        ...
                        <img src="<?= htmlspecialchars($post['AVATAR_URL_FIXED']) ?>" alt="Avatar"
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center flex-wrap space-x-1 mb-1">
                            ...
                            <span
                                class="text-gray-500 text-sm truncate">@<?= htmlspecialchars($post['USERNAME']) ?></span>
                        ...
                        <div class="cursor-pointer mb-2">
                            ...
                            <p class="text-gray-800 text-[15px] leading-normal break-words whitespace-pre-wrap">
                                <?= htmlspecialchars($post['KONTEN']) ?></p>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex items-center justify-between mt-3 max-w-md text-gray-500">
                            ...
                            <button onclick="event.stopPropagation(); handleLike(this, <?= $post['POST_ID'] ?>)"
                                ...
                                <div class="p-2 rounded-full group-hover:bg-red-50 transition-colors relative">
                                    <img src="/Sinergi/public/assets/icons/heart.svg" alt="Like"
                            ...
                            <button
                                class="group flex items-center space-x-2 hover:text-green-500 transition-colors w-fit"
                                ...
                                <div class="p-2 rounded-full group-hover:bg-green-50 transition-colors">
                                    <img src="/Sinergi/public/assets/icons/report.svg" alt="Laporkan" class="w-5 h-5">
                                </div>
                            </button>
