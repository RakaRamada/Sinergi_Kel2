        ...
        <div class="max-w-6xl mx-auto px-6 w-full">
            ...
            <div class="relative pt-8 pb-6 md:flex items-end gap-8">
                ...
                <div class="flex-1 mb-2 mt-4 md:mt-0">
                    ...
                    <div class="flex flex-wrap items-center text-sm text-gray-500 gap-4">
                        ...
                        <?php else: ?>
                        <div class="flex items-center gap-1.5 bg-blue-50 px-2 py-1 rounded text-blue-600 font-medium">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="flex items-center gap-6 mt-6 overflow-x-auto">
                <?php 
                    ...
                    $tab_active = "border-blue-600 text-blue-600";
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-10 text-center">
                ...
                <a href="index.php?page=messages&group_id=<?= $group_id ?>&tab=forum"
                    class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold transition shadow-lg shadow-blue-200">Buka
                    Forum Diskusi</a>
            </div>
            <?php endif; ?>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-3 md:grid-cols-4 gap-3">
                    ...
                    <a href="/Sinergi/public/uploads/group_files/<?= $m['file_path'] ?>" target="_blank"
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="space-y-3">
                    ...
                    <a href="/Sinergi/public/uploads/group_files/<?= $d['file_path'] ?>"
                        class="flex items-center p-4 border border-gray-200 rounded-xl hover:bg-blue-50 hover:border-blue-200 transition group bg-gray-50">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="font-bold text-gray-900 truncate group-hover:text-blue-700 text-base">
                                <?= htmlspecialchars($d['original_filename']) ?></p>
                    ...
                    <div class="py-3 flex items-center justify-between">
                        ...
                        <div class="flex gap-1">
                            <a href="index.php?page=process-request&action=approve&group_id=<?= $group_id ?>&user_id=<?= $pm['user_id'] ?>"
                                class="p-1.5 bg-blue-600 text-white rounded hover:bg-blue-700" title="Terima"><svg
        ...
        <div class="p-3 border-b border-gray-100">
            <div class="relative">
                <input type="text" id="searchCandidateInput" placeholder="Cari nama teman..." autocomplete="off"
                    class="w-full pl-10 pr-4 py-2 bg-gray-100 border-none rounded-lg text-sm focus:ring-2 focus:ring-blue-600 focus:bg-white transition placeholder-gray-500">
    ...
    <div
        ...
        <div class="mt-6 flex justify-center gap-3">
            ...
            <button type="button" id="btnConfirmYes"
                class="px-4 py-2 bg-blue-600 text-white text-base font-medium rounded-lg hover:bg-blue-700 shadow-lg shadow-blue-500/30 transition cursor-pointer">Ya,
                Undang</button>
        </div>
    </div>
</div>
    ...
    fetch(`index.php?page=api-search-candidates&group_id=${groupId}&q=${encodeURIComponent(query)}`)
        ...
        .then(data => {
            ...
            data.forEach(user => {
                ...
                item.className =
                    'flex items-center p-3 hover:bg-blue-50 rounded-lg cursor-pointer transition border-b border-gray-50 last:border-0';
                item.onclick = () => submitAddMember(user.user_id, user.nama_lengkap);
                item.innerHTML =
                    `<img src="${avatarPath}" class="w-10 h-10 rounded-full bg-gray-200 mr-3 object-cover border border-gray-200"><div class="flex-1"><p class="font-bold text-gray-800 text-sm">${user.nama_lengkap}</p><p class="text-xs text-gray-500">@${user.username}</p></div><div class="text-blue-600 bg-blue-100 p-1.5 rounded-full"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path></svg></div>`;
...
function kickUser(userId, name) {
    if (confirm(`Yakin ingin mengeluarkan ${name} dari grup?`)) {
        window.location.href =
            `index.php?page=kick-member&group_id=<?= $group_id ?>&user_id=${userId}&name=${encodeURIComponent(name)}`;
    }
}
</script>